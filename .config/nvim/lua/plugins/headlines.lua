...
--     vim.cmd([[highlight Headline4 guibg=#f265b5 guifg=#09090d]])
--     vim.cmd([[highlight Headline3 guibg=#37f499 guifg=#09090d]])
--     vim.cmd([[highlight Headline2 guibg=#04d1f9 guifg=#09090d]])
--     vim.cmd([[highlight Headline1 guibg=#a48cf2 guifg=#09090d]])
--     vim.cmd([[highlight Headline5 guibg=#f1fc79 guifg=#09090d]])
--     vim.cmd([[highlight Headline6 guibg=#f7c67f guifg=#09090d]])
--
...
--
    ...
    vim.cmd([[highlight CodeBlock guibg=#060614]])
...
--     -- Setup headlines.nvim with the newly defined highlight groups
    require("headlines").setup({
      markdown = {
        ...
        -- ===================== UNCOMMENT HEADLINES TO ENABLE AGAIN =================================
        headline_highlights = {
          -- "Headline1",
          -- "Headline2",
          -- "Headline3",
